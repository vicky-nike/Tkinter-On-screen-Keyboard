...
def display_keyboard():
    ...
    positionDown = int(root.winfo_screenheight()/2 - 180/2)
    
    key.geometry("{}x{}+{}+{}".format(600, 180, positionRight, (positionDown+210)))
    style = ttk.Style()
    ...
    def keyboard_display():
            ...
            num1.place(anchor='w', relheight=0.42, relwidth=0.14, relx=0.03, rely=0.25)

            num2 = ttk.Button(key, text='2', command=lambda: press('2'))
            num2.place(anchor='w', relheight=0.42, relwidth=0.14, relx=0.19, rely=0.25)

            num3 = ttk.Button(key, text='3', command=lambda: press('3'))
            num3.place(anchor='w', relheight=0.42, relwidth=0.14, relx=0.35, rely=0.25)

            num4 = ttk.Button(key, text='4', command=lambda: press('4'))
            num4.place(anchor='w', relheight=0.42, relwidth=0.14, relx=0.51, rely=0.25)

            num5 = ttk.Button(key, text='5', command=lambda: press('5'))
            num5.place(anchor='w', relheight=0.42, relwidth=0.14, relx=0.67, rely=0.25)

            theme = ttk.Button(key, text='Theme', command=Theme)
            theme.place(anchor='w', relheight=0.42, relwidth=0.14, relx=0.83, rely=0.25)

            num6 = ttk.Button(key, text='6', command=lambda: press('6'))
            num6.place(anchor='w', relheight=0.42, relwidth=0.14, relx=0.03, rely=0.72)

            num7 = ttk.Button(key, text='7', command=lambda: press('7'))
            num7.place(anchor='w', relheight=0.42, relwidth=0.14, relx=0.19, rely=0.72)

            num8 = ttk.Button(key, text='8', command=lambda: press('8'))
            num8.place(anchor='w', relheight=0.42, relwidth=0.14, relx=0.35, rely=0.72)
            
            num9 = ttk.Button(key, text='9', command=lambda: press('9'))
            num9.place(anchor='w', relheight=0.42, relwidth=0.14, relx=0.51, rely=0.72)

            num0 = ttk.Button(key, text='0', command=lambda: press('0'))
            num0.place(anchor='w', relheight=0.42, relwidth=0.14, relx=0.67, rely=0.72)

            enter = ttk.Button(key, text='Enter', command=lambda: key.destroy())
            enter.place(anchor='w', relheight=0.42, relwidth=0.14, relx=0.83, rely=0.72)
